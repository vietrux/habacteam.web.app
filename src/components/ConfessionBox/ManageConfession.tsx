...
export default function ManageConfession() {
  ...
  const q = query(collection(db, "cfs-box"), where("uid", "==", user.uid || localStorage.getItem("user_uid")));
    ...
    <>
      <div className="w-full h-screen overflow-y-auto">
        ...
        <div className="flex w-full">
          ...
          <Link to="/u/addcfs" className="w-[31%] mx-auto py-2 bg-yellow-300 text-black text-center rounded-lg shadow-lg shadow-slate-300">
            Thêm mới
          </Link>
        </div>
