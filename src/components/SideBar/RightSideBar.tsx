      ...
      <div className={
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-2 my-4 text-white ">
          <div className="bg-blue-600 rounded-2xl shadow-2xl shadow-slate-400 p-4 py-8">
            ...
            <p className="text-center text-[48px] font-bold ">{props.fan_count}</p>
            <p className="text-center text-sm">From HMC with love</p>
          </div>
          <div className="bg-yellow-400 rounded-2xl shadow-2xl shadow-slate-400 p-4 py-8 text-center">
