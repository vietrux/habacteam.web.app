    ...
    <>
      <div className="h-screen col-span-1 sm:grid sm:grid-rows-3 border-r border-gray-200 bg-white hidden">
        <div className=" grid place-content-center">
          ...
          <h1 className="mt-6 mb-2 mx-auto text-center text-lg text-slate-700 font-['Cubano']">Ha Bac Team</h1>
          <p className=" mx-auto text-center text-slate-500">News &amp; Entertainment</p>
        </div>
        <div className="flex flex-col">
          ...
          <div className="flex flex-col mx-auto my-6">
            ...
            <Link to="/g/hmc" className="my-2 p-2 text-slate-600 hover:text-green-900 font-semibold">
              <i className="fa-regular fa-photo-film-music fa-lg"></i> <span className="ml-2">HMC</span>
            </Link>
            <Link to="/g/hr" className="my-2 p-2 text-slate-600 hover:text-green-900 font-semibold">
